										...
										case "bilibili.app.viewunite.v1.View": // 视频(内测)
											switch (PATHs?.[1]) {
												case "View": // 视频播放页
													...
													class ViewReply$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.ViewReply",[{no:5,name:"tab",kind:"message",T:()=>Tab},{no:7,name:"cm",kind:"message",T:()=>CM}])}}const ViewReply=new ViewReply$Type;class Tab$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.Tab",[{no:1,name:"tab_module",kind:"message",repeat:1,T:()=>TabModule}])}}const Tab=new Tab$Type;class TabModule$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.TabModule",[{no:2,name:"introduction",kind:"message",oneof:"tab",T:()=>IntroductionTab}])}}const TabModule=new TabModule$Type;class IntroductionTab$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.IntroductionTab",[{no:2,name:"modules",kind:"message",repeat:1,T:()=>Module}])}}const IntroductionTab=new IntroductionTab$Type;class Module$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.Module",[{no:1,name:"type",kind:"scalar",T:5},{no:22,name:"relates",kind:"message",oneof:"data",T:()=>Relates}])}}const Module=new Module$Type;class Relates$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.Relates",[{no:1,name:"cards",kind:"message",repeat:1,T:()=>RelateCard}])}}const Relates=new Relates$Type;class RelateCard$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.RelateCard",[{no:1,name:"relate_card_type",kind:"scalar",T:5}])}}const RelateCard=new RelateCard$Type;class CM$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.CM",[{no:3,name:"source_content",kind:"message",repeat:1,T:()=>Any},{no:5,name:"content5",kind:"message",T:()=>Info5}])}}const CM=new CM$Type;class Info5$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.Info5",[{no:1,name:"content1",kind:"message",T:()=>Info51}])}}const Info5=new Info5$Type;class Info51$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.Info51",[{no:2,name:"content2",kind:"message",T:()=>Info512}])}}const Info51=new Info51$Type;class Info512$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.Info512",[{no:9,name:"content9",kind:"message",T:()=>Info5129}])}}const Info512=new Info512$Type;class Info5129$Type extends MessageType{constructor(){super("bilibili.app.viewunite.v1.Info5129",[])}}const Info5129=new Info5129$Type;
													/******************  initialization finish  ******************/
													...
													break;
												case "RelatesFeed":
													let data = RelatesFeedReply.fromBinary(body)
													data.relates = data.relates.filter((item) => {
													...
													body = RelatesFeedReply.toBinary(data)
													break;
											}
											break;
